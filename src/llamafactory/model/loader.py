...
from .model_utils.checkpointing import validate_kt_deepseek_v3_native_config
from .model_utils.fsdp import patch_fsdp2_kt_parameter_identity
...
def load_model(
    ...
    validate_kt_deepseek_v3_native_config(config, model_args)
